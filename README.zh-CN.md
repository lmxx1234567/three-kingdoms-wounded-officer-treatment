...
华佗或《青囊书》已在其他派系时，华佗仍可能游历至此并提供治疗，只隐藏对应的唯一物品选项。当前派系一旦成功招揽或查取医书，今后的同类随机事件会改为没有彩蛋选项的“名医来访”。事件触发后有8回合冷却；概率、费用和冷却均可在 `pack_root/script/campaign/mod/a_wota_config.lua` 中调整。
