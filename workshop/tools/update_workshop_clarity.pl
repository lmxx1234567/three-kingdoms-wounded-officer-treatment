...
$main_usage =~ s{A treatment lasts at least one season, and the full course may take a year\.}{Treatment by ordinary physicians requires a year of recuperation; paying for a renowned physician such as Hua Tuo completes it in just one season.};
